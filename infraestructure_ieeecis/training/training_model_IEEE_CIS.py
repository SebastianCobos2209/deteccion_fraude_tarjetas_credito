"""
================================================================================
SCRIPT: training_model_IEEE_CIS.py
PROPOSITO: Entrenamiento del Modelo Base de Isolation Forest (Todas las Variables).
TIPO DE ARCHIVO: Entrenamiento / Modelado
================================================================================

DESCRIPCION:
Este script carga el dataset limpio 'train_cleaned.csv', aplica ingeniería de
características básica (amt_ratio, log_amt, Label Encoding para categóricas)
y entrena un modelo Isolation Forest básico utilizando la totalidad de las 
variables limpias (más de 300 características). Sirve para establecer el F1-Score y 
la latencia base para comparar con los enfoques optimizados.
...
2. EJECUTAR ESTE SCRIPT (`training_model_IEEE_CIS.py`) para registrar el modelo base.
3. Ejecutar `training_model_IEEE_CIS_tuned.py` (Modelo con afinación de hiperparámetros).
